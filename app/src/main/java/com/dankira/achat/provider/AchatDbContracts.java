...
public class AchatDbContracts
{
    ...
    public static final int DATABBASE_VERSION = 1;
    ...
    public static final class ShoppingItemTable implements BaseColumns
    {
        ...
        public static final String ID_ShoppingList = "id_sl";
        ...
        public static final String CREATE_SQL = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "( " +
                _ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ID_ShoppingList + " INTEGER NOT NULL REFERENCES " + ShoppingListTable.TABLE_NAME +
                "(" + ShoppingListTable._ID + ") ON DELETE CASCADE," +
